...
public class SerializableCommandTest extends TestCase {
    ...
    // // gsonBuilder.registerTypeAdapter(ParameterType.class, new
    ...
    // String json = gson.toJson(columnsType, ConcreteType.class);
    // ParameterType.ConcreteType type = gson.fromJson(json,
    // ConcreteType.class);
    // System.out.println("columns0: " +
    // columnsType.generateRandomParameter(null, null).toString());
    // System.out.println("columns1: " + type.generateRandomParameter(null,
    // null).toString());
    // }
    ...
    // // ParameterType.ConcreteType primaryColumnsType = new
    // ParameterType.NotEmpty(new ParameterType.SubsetType(
    // // columnsType, (s, c) -> (Collection<Parameter>)
    // c.params.get(2).getValue(), null));
    ...
    // CassandraCommands.CREAT_KEYSPACE cmd0 = new
    // CassandraCommands.CREAT_KEYSPACE(s);
    // cmd0.updateState(s);
    ...
    // CassandraCommands.CREATETABLE cmd0 = new
    ...
    // CassandraCommands.CREATETABLE cmd1 = new
    // CassandraCommands.CREATETABLE(s);
    // cmd1.updateState(s);
