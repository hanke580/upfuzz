...
public class OzoneVolumeType extends ParameterType.ConcreteType {
    ...
    public Parameter generateRandomParameter(State s, Command c) {
        ...
        String dirPath = ozoneState.oos.getRandomVolumePath();
    ...
    public String generateStringValue(Parameter p) {
        assert p != null && p.type instanceof OzoneVolumeType;
        return (String) p.value;
    }

    @Override
    public boolean isValid(State s, Command c, Parameter p) {
        return ((OzoneState) s).oos.containsVolume((String) p.getValue());
    }
