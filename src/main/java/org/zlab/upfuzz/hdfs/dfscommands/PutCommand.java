...
public class PutCommand extends DfsCommands {
    ...
    public PutCommand(HdfsState hdfsState) {
        ...
        // -p : Preserves access and modification times, ownership and the permissions. (assuming
        // the permissions can be propagated across filesystems)
        Parameter pOption =
        ...
        Parameter lOption =
                new ParameterType.OptionalType(new CONSTANTSTRINGType("-l"), null)
                        .generateRandomParameter(null, null);
