...
public class HDFSCommands extends Command {
    ...
    public static class setacl extends HDFSCommands {
        ...
        public setacl() {
            ...
            // -b|-k
            Parameter BandK = new ParameterType.InCollectionType(CONSTANTSTRINGType.instance,
                    Arrays.asList(new CONSTANTSTRINGType("-b").generateRandomParameter(null, null), new CONSTANTSTRINGType("-k").generateRandomParameter(null, null)), null)
                            .generateRandomParameter(null, null);

            // -m|-x
            Parameter MandX = new ParameterType.InCollectionType(CONSTANTSTRINGType.instance,
                    Arrays.asList(new CONSTANTSTRINGType("-m").generateRandomParameter(null, null), new CONSTANTSTRINGType("-x").generateRandomParameter(null, null)), null)
                            .generateRandomParameter(null, null);
            ...
            // {-m | -x <acl_spec>}
            Parameter mxaclSpec = new ParameterType.ConcatenateType(null, Arrays.asList(MandX, aclSpec))
                    .generateRandomParameter(null, null);
            ...
            Parameter bkmxaclPath = new ParameterType.ConcatenateType(null, Arrays.asList(BandK, mxaclSpec, path1))
                    .generateRandomParameter(null, null);
            ...
            Parameter setACLPATH = new ParameterType.ConcatenateType(null, Arrays.asList(hyphenSet, aclSpec1, path2))
                    .generateRandomParameter(null, null);

            // [{-b|-k} {-m|-x <acl_spec>} <path>]|[--set <acl_spec> <path>]
            Parameter fullACLBKMXPATH = new ParameterType.ConcatenateType<>(null, Arrays.asList(bkmxaclPath, setACLPATH))
                    .generateRandomParameter(null, null);
