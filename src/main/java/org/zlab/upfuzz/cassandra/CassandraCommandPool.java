...
import org.zlab.upfuzz.cassandra.CassandraCommands.CREATETABLE;
...
public class CassandraCommandPool extends CommandPool {
    ...
    public CassandraCommandPool() {
        ...
        commandClassList.add(
                new AbstractMap.SimpleImmutableEntry<>(CREATETABLE.class, 1));
        commandClassList
        ...
        createCommandClassList.add(
                new AbstractMap.SimpleImmutableEntry<>(CREATETABLE.class, 3));
