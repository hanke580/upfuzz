...
public class HBaseCommandPool extends CommandPool {
    ...
    public HBaseCommandPool() {
        ...
        commandClassList.add(new AbstractMap.SimpleImmutableEntry<>(ALTER_ADD_FAMILY.class, 5));
        commandClassList.add(new AbstractMap.SimpleImmutableEntry<>(ALTER_DELETE_FAMILY.class, 5));
        ...
        commandClassList.add(new AbstractMap.SimpleImmutableEntry<>(PUT_NEW_ITEM.class, 5));
        commandClassList.add(new AbstractMap.SimpleImmutableEntry<>(DELETE.class, 5));
        commandClassList.add(new AbstractMap.SimpleImmutableEntry<>(DELETEALL.class, 5));
        commandClassList.add(new AbstractMap.SimpleImmutableEntry<>(PUT_NEW_ITEM.class, 5));
        commandClassList.add(new AbstractMap.SimpleImmutableEntry<>(GET.class, 5));
        commandClassList.add(new AbstractMap.SimpleImmutableEntry<>(PUT_MODIFY.class, 5));
        commandClassList.add(new AbstractMap.SimpleImmutableEntry<>(PUT_NEW_COLUMN.class, 5));
        commandClassList.add(new AbstractMap.SimpleImmutableEntry<>(PUT_NEW_COLUMN_and_NEW_ITEM.class, 1));
        commandClassList.add(new AbstractMap.SimpleImmutableEntry<>(SCAN.class, 5));
        commandClassList.add(new AbstractMap.SimpleImmutableEntry<>(TRUNCATE.class, 5));
